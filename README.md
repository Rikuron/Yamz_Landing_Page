...
│   ├── servicePosts.tsx # Interactive service modal component <br>
│   ├── productCard.tsx  # Product display components <br>
│   └── ... <br>
├── data/ # Static data files (e.g., services.json) <br>
│   ├── services.ts     # Service definitions with TypeScript interfaces <br>
│   └── products.ts     # Product data <br>
