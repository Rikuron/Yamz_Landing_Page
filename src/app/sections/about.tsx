  ...
  return (
    <div className="px-15 pb-15 pt-20 text-center">
      ...
      <div className="inline-block">
        ...
        <div className="h-1.5 -mx-8 bg-gradient-to-r from-blue-500 to-white rounded-full" />
      </div>
        <Swiper
          cssMode={true}
          navigation={true}
            ...
            <div className="flex flex-col md:flex-row px-20 items-center justify-center gap-8 p-8">
              <div className="md:w-1/2">
                ...
                <p className="mb-8 max-w-md">
                    Our vision is to be the leading provider of innovative and reliable technology solutions, 
                    empowering individuals and businesses to achieve their full potential.
                </p>
              </div>
              <div className="md:w-1/2">
